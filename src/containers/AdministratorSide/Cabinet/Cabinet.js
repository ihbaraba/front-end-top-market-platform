                    ...
                    {/*<div className={styles.userBlock}>*/}
                        {/*<div className={styles.userContacts}>*/}
                            ...
                            {/*<div className={styles.userInfo}>*/}
                                ...
                                {/*<p>Статус:  <span className={styles.notActivated}>Неактивирован</span></p>*/}
                                {/*<p>Статус Компании:  <span className={styles.notActivated}>Неактивирован</span></p>*/}
                        ...
                        {/*<div className={styles.tariffsBox}>*/}
                            {/*<div className={styles.tariffItem}>*/}
                                ...
                                {/*<div className={styles.tariffBody}>*/}
                                    ...
                                    {/*</ul>*/}
                                {/*</div>*/}
                                {/*<a href="#" className={styles.buyBtn}>Купить</a>*/}
                            {/*</div>*/}
                            {/*<div className={styles.tariffItem}>*/}
                                {/*<div className={styles.tariffHead}>*/}
                                    {/*<p>Базовый</p>*/}
                            ...
                            <div className={styles.feeds}>
                                <div className={styles.post}>
                                    ...
                                    <div className={styles.actionLink}>
                                        <a href="#"><img src="" alt=""/>Мне нравится </a>
                                        <a href="#"><img src="" alt=""/>Комментарии (0)</a>
                                    </div>
