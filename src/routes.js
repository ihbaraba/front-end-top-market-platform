...
import InstructionsForSellers from "./containers/AdministratorSide/Instruction/InstructionsForSellers";
            ...
            <Switch>
                ...
                <Route path='/admin' render={() => (
                    <AdministratorSide>
                      ...
                      <Route path='/admin/instruction_sellers' component={InstructionsForSellers}/>
